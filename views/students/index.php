        ...
        <header>
            ...
            <div class="header-right">
                <div class="notification-container">
                    <a href="messages.html" class="bell" aria-label="notifications">
            ...
            <aside class="big-sidebar">
                <nav>
                    <ul>
                        ...
                        <li class="hideOnMobile active-nav"><a href="students.html" class="nav-link">Students</a></li>
            ...
            <aside class="small-sidebar">
                <nav>
                    <ul>
                        ...
                        <li class="active-nav"><a href="students.html" class="nav-link">Students</a></li>
